# Character limit for this hashing algorithm is 55 characters as the Chunk Loop has been omitted
...
def hashPassword(getPassword):
    ...
    # Initialises round constants with the cube roots of the first 64 prime numbers in Hexadecimal
